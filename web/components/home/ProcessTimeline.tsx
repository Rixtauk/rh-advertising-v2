  ...
  const steps = [
    {
      ...
      description:
        'Select from Education Ad Copy Generator, University Landing Page Optimiser, Creative Asset Spec Query Tool, or Education Insight Assistant based on your campaign needs.',
      icon: (
